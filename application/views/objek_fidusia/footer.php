  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="#">Sugih Haryati - Notary & PPAT.</a></strong> All rights
    reserved.
  </footer>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable1").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "kategori_objek/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_kategori",
                            "orderable": false
                        },{"data": "kategori"},{"data": "jenis_kategori"},
                        {
                            "data" : "action",
                            "orderable": false,
                ...
                var t = $("#mytable2").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "objek_fidusia/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_objek",
                            "orderable": false
						...
						{"data": "nomes_objek"},
						{"data": "warna_objek"},
						{"data": "bukti_objek","render": function(data, type, row)
							{return '<img src="<?php echo base_url('assets/upload/objek/'); ?>'+data+'"style="height:100px;width:100px;"/>';}},
						{"data": "nilai_objek"},
