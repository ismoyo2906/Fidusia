        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "progress/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_pjm_fidusia",
                            "orderable": false
...
<script>
<?php if($this->session->userdata('role') == "Notaris"){ ?>
 
  $(document).ready(function(){
 
    $("#progressblockuser").hide();
    $("#progressblockuser").remove();
 
  });
  
<?php } else if($this->session->userdata('role') == "Staff Akta"){ ?>
